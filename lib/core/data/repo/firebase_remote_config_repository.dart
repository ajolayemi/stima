...
class FirebaseRemoteConfigRepository implements ConfigRepository {
  ...
  static final _logger = Logger('FirebaseRemoteConfigRepository');
  ...
  Future<void> setup() async {
    ...
    _logger.info('config activated - $configActivated');
  }
  ...
  VersionUpdateConfig getVersionUpdateConfig() {
    ...
    _logger.fine('Fetched version update config: $value');
